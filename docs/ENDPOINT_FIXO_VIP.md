...
```powershell
powershell -ExecutionPolicy Bypass -File tools/start_with_vip.ps1
```
...
```powershell
powershell -ExecutionPolicy Bypass -File tools/start_with_vip.ps1 -VirtualIp 192.168.0.250 -PrefixLength 24
```
